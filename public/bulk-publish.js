...
$('#reviewBulkPublish').addEventListener('click',async()=>{
  ...
  try{
    ...
    const accepted=window.confirm(`${r.items.length} sayfa canlıya yayınlanacak:\n\n${lines}\n\n${r.skipped.length} gerçek öneri ayrıca karar bekliyor. Yalnız listelenen başlık, meta ve H1 değişiklikleri uygulanır. İlk hatada kalan kuyruk durur; yayınlanan sayfalar otomatik geri alınmaz.\n\nHepsini şimdi canlıya yayınla?`);
